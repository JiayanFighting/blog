...
import com.jiayan.blog.aad.AuthHelper;
...
import com.jiayan.blog.utils.Graph;
import com.jiayan.blog.utils.Query;
...
//        }
    ...
    public Result getReportContent(@RequestBody Map<String,Object> params){
        log.info("/report/content:teamId="+params.toString());
        ReportDO report = reportService.getReportDetail(params);
        System.out.println("content params"+params);
        if (report == null) {
            return Result.error(-1,"no found");
        }
        Result res = new Result();
        System.out.println("content res: " + res);
...
//            System.out.println("replaced:" + replaced);
    ...
    public Result joinedTeamList(@RequestBody Map<String, Object> params){
        ...
        Result res = new Result();
        List<UserDO> peopleToRemind = reportService.peopleToRemind(params, createdList);
