...
class Modal extends Component {
    ...
    render() {
        ...
        let {okBtnType, showOk, title, okMessage, cancelBtnType, showCancel, cancelMessage, children,showMidButton,midMessage} = this.props;
        ...
        return (
            ...
            <div className={"modal"}>
                <section className={"modal-main"}>
                    ...
                    {showMidButton?<Button onClick={this.props.handleClickMid} type={okBtnType} className={"okBtn"}>{midMessage}</Button>:''}
                    <Button
                        className={"cancelBtn"}
                        type={cancelBtnType}
