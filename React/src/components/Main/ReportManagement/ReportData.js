...
class ReportData extends Component {
    ...
    download = () => {
        ...
        FileSaver.saveAs(blob, this.state.report.theme+".md");
    };
    ...
    showDetails = (record) => {
        ...
        getSprintService(teamId,sprint,type).then((res)=>{
            ...
            if(res.res.statusCode === 0 && cur >= res.res.beginTime && cur <= res.res.endTime && record.fromEmail===this.state.userEmail){
                this.setState({
    ...
    render() {
        ...
        const columns = [
            ...
            },
            {
                ...
                key: 'action',
                render: (text, record) => (
                    <Button type={"primary"} onClick={() => {this.showDetails(record)}}>Show Details</Button>
                ),
            },
        ];
        return (
